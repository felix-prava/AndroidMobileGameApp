...
public class MainMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectDifficulty.setOnClickListener(v -> {
            Intent intent = new Intent(MainMenuActivity.this, SelectDifficulty.class);
            startActivity(intent);
        });
        ...
        viewHighScore.setOnClickListener(v -> {
            ...
            displayMessage("Highest Score: " + highestScore);
        });
        ...
        addCoins.setOnClickListener(v -> {
            ...
            if (userCanPlay) {
                ...
                displayMessage("You must play a game before trying to earn more coins!");
            }
        });
